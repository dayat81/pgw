...
//    }
//    
//    //create thread to listen downstream
//    pthread_t threaddown;
//    int iretdown = pthread_create( &threaddown, NULL, listendown, (void*)&threadnum);
//    if(iretdown)
//    {
//        fprintf(stderr,"Error - pthread_create() return code: %d\n",iretdown);
//        exit(EXIT_FAILURE);
